...
function EditBook() {
  ...
  useEffect(() => {
    fetch(`http://127.0.0.1:8000/api/books/${id}`)
      ...
      .then((data: Book) => {
        setTitle(data.title);
        setAuthor(String(data.author.id));
        setSummary(data.summary);
        setISBN(data.isbn);
        setLanguage(String(data.language.id));
  ...
  return (
    <div className="container mt-5 my-form">
      <div className="my-create-book-title">Edit book</div>
        ...
        <div className="mb-3">
          ...
          {coverUrl && (
            <div className="mb-2 text-center">
              ...
              />
              <div className="text-muted small">Current cover</div>
            </div>
          )}
          <input
            type="file"
